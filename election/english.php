...
<div class="container">
    ...
    <div class="row d-flex">
        ...
        <?php
        $president_qry = mysqli_query($connections, "SELECT * FROM candidatestbl WHERE position='President' AND course='English' AND status='Active' ");
        ...
        <?php
        $vice_president_qry = mysqli_query($connections, "SELECT * FROM candidatestbl WHERE position='Vice President' AND course='English' AND status='Active' ");
        ...
        <?php
        $secretary_qry = mysqli_query($connections, "SELECT * FROM candidatestbl WHERE position='Secretary' AND course='English' AND status='Active' ");
        ...
        <?php
        $assistant_secretary_qry = mysqli_query($connections, "SELECT * FROM candidatestbl WHERE position='Assistant Secretary ' AND course='English' AND status='Active' ");
        ...
        <?php
        $treasurer_qry = mysqli_query($connections, "SELECT * FROM candidatestbl WHERE position='Treasurer' AND course='English' AND status='Active' ");
        ...
        <?php
        $assistant_treasurer_qry = mysqli_query($connections, "SELECT * FROM candidatestbl WHERE position='Assistant Treasurer' AND course='English' AND status='Active' ");
        ...
        <?php
        $auditor_qry = mysqli_query($connections, "SELECT * FROM candidatestbl WHERE position='Auditor' AND course='English' AND status='Active' ");
        ...
        <?php
        $business_manager_qry = mysqli_query($connections, "SELECT * FROM candidatestbl WHERE position='Business Manager' AND course='English' AND status='Active' ");
        ...
        <?php
        $pio_qry = mysqli_query($connections, "SELECT * FROM candidatestbl WHERE position='P.I.O.' AND course='English' AND status='Active' ");
        ...
        <?php
        $first_year_representative_qry = mysqli_query($connections, "SELECT * FROM candidatestbl WHERE position='First Year Representative' AND course='English' AND status='Active' ");
        ...
        <?php
        $second_year_representative_qry = mysqli_query($connections, "SELECT * FROM candidatestbl WHERE position='Second Year Representative' AND course='English' AND status='Active' ");
        ...
        <?php
        $third_year_representative_qry = mysqli_query($connections, "SELECT * FROM candidatestbl WHERE position='Third Year Representative' AND course='English' AND status='Active' ");
        ...
        <?php
        $fourth_year_representative_qry = mysqli_query($connections, "SELECT * FROM candidatestbl WHERE position='Fourth Year Representative' AND course='English' AND status='Active' ");
